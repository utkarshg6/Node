...
pub fn generate_wallets_subcommand() -> App<'static> {
    SubCommand::new("generate-wallets")
        ...
        .arg(Arg::new ("word-count")
            .about("The number of words that should be generated for the wallets' mnemonic phrase")
            .long("word-count")
        ...
        .arg(Arg::new("passphrase")
            .about("An optional additional word(it can be any word) that the wallet-recovery process should require at the end of the mnemonic phrase")
            .long("passphrase")
