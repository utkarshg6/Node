...
pub fn recover_wallets_subcommand() -> App<'static> {
    SubCommand::new("recover-wallets")
        ...
        .arg(Arg::new ("db-password")
            .about ("The current database password (a password must be set to use this command)")
            .long ("db-password")
        ...
        .arg(Arg::new ("mnemonic-phrase")
            .about ("The mnemonic phrase upon which the consuming wallet (and possibly the earning wallet) is based. Surround with double quotes.")
        ...
        .arg(Arg::new ("passphrase")
            .about ("An additional word--any word--to place at the end of the mnemonic phrase to recover the wallet pair")
            .long ("passphrase")
        ...
        .arg(Arg::new ("language")
            .about ("The language in which the wallets' mnemonic phrase should be generated")
            .long ("language")
            .value_name ("LANGUAGE")
            .required (false)
        ...
        .arg(Arg::new ("consuming-path")
            .about ("Derivation path from which to generate the consuming wallet from which your bills will be paid. Remember to put it in double quotes; otherwise the single quotes will cause problems")
            .long ("consuming-path")
            .value_name ("CONSUMING-PATH")
            .required (true)
            .takes_value (true)
        )
        .arg(Arg::new ("earning-path")
            .about ("Derivation path from which to generate the earning wallet from which your bills will be paid. Can be the same as consuming-path. Remember to put it in double quotes; otherwise the single quotes will cause problems")
            .long ("earning-path")
            .value_name ("EARNING-PATH")
            .required (false)
            .takes_value (true)
        )
        .arg(Arg::new ("earning-address")
            .about ("Address of earning wallet. Supply this instead of --earning-path if the earning wallet is not derived from the mnemonic phrase")
